...
export const Button = ({ variant = "primary", className, ...props }: ButtonProps) => {
  ...
  const variants = {
    primary: "bg-blue-600 text-white hover:bg-blue-700 hover:cursor-pointer rounded-md shadow-md",
    secondary: "bg-gray-500 text-white hover:bg-gray-600 hover:cursor-pointer rounded-md shadow-md",
    danger: "bg-red-600 text-white hover:bg-red-700 hover:cursor-pointer rounded-md shadow-md",
  };
